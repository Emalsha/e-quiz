<?php 	
		...
		if (isset($_POST['submit'])) {
			...
			if ($results == 1 | $username=="" ) {
				...
				$query = "INSERT INTO users (fname,lname,email,username,password,login_time) VALUES ('$fname','$lname','$email','$username','$password',NOW())";

				$res = mysqli_query($conn,$query);

				if($res == 1){
					echo "<script type='text/javascript'> alert('Congratulations. You registration complete.');</script>";	
				}else{
...
<body>
	...
	<div class="container">
		<div class="container-inside">
			...
			<div class="block">
				<center>
				<p style="font-size:.8em;">Already a member.</p>
